          ...
          <Row>
            ...
            <Col md={3}>
              <ListGroup variant='light'>
                ...
                <ListGroup.Item>{show.hallKind.kind ==='VIP' ? 'Price: ' +show.hallKind.price :  show.movie.discountedPrice ? <p>Price: <del>{addDecimals(show.movie.price+show.hall.hallKind.price)}</del>${addDecimals(show.movie.discountedPrice +show.hall.hallKind.price)}</p> :<p>Price: ${addDecimals(show.movie.price+show.hall.hallKind.price)}</p> }</ListGroup.Item>
              </ListGroup>
            </Col>
            <Col md={3}>
              <Card>
